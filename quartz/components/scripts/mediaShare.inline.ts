...
function createShareDropdown() {
	...
	if (platforms.includes('facebook')) {
		dropdownContent += `
            <a href="https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}" target="_blank" rel="noopener noreferrer" class="share-option">
	...
	if (platforms.includes('linkedin')) {
		dropdownContent += `
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}" target="_blank" rel="noopener noreferrer" class="share-option">
	...
	if (platforms.includes('reddit')) {
		dropdownContent += `
            <a href="https://www.reddit.com/submit?url=${encodedUrl}" target="_blank" rel="noopener noreferrer" class="share-option">
                <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" fill="none">
	...
	if (platforms.includes('twitter')) {
		dropdownContent += `
            <a href="https://twitter.com/intent/tweet?url=${encodedUrl}" target="_blank" rel="noopener noreferrer" class="share-option">
                <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" fill="none">
	...
	if (platforms.includes('instagram')) {
		dropdownContent += `
            <a href="https://www.instagram.com/?url=${encodedUrl}" target="_blank" rel="noopener noreferrer" class="share-option">
                <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 32 32" fill="none">
	...
	if (showCopy) {
		dropdownContent += `
            <button class="share-option copy-link" id="copy-link">
                ...
                <span>${i18n(locale as any).components.mediaShare?.copyLink ?? "Copy Link"}</span>
            </button>
        `;
	}
